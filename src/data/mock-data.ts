...
export const mockMentors: Mentor[] = [
  // APPROVED (4)
  { id: "mentor_001", userId: "usr_001", name: "김민수", nickname: "김창업", email: "minsu.kim@techstart.kr", phone: "010-2345-0001", profileImageUrl: "", companyName: "테크스타트 주식회사", companyType: "스타트업", position: "대표이사", category: "투자/IR", introduction: "시리즈B까지 완료한 스타트업 대표입니다. IR 피칭과 투자유치 전반에 대해 멘토링합니다.", career: "테크스타트 창업 3년, 시리즈B 80억 유치, 전 삼성전자 사업기획", expertise: ["시리즈A", "시리즈B", "IR피칭", "사업계획서"], availableTime: "평일 오후 2-5시", mentoringCount: 15, rating: 4.8, status: "APPROVED", rejectReason: "", adminMemo: "", appliedAt: "2026-01-20T09:00:00Z", approvedAt: "2026-01-22T10:00:00Z", createdAt: "2026-01-20T09:00:00Z", updatedAt: "2026-03-01T09:00:00Z" },
  { id: "mentor_002", userId: "usr_007", name: "오상원", nickname: "오벤처", email: "sangwon.oh@koreainvest.kr", phone: "010-1234-0007", profileImageUrl: "", companyName: "코리아인베스트", companyType: "투자사", position: "파트너", category: "투자/IR", introduction: "VC 10년차 파트너입니다. 초기 스타트업 투자심사와 밸류에이션에 대해 조언합니다.", career: "코리아인베스트 파트너 5년, 전 KB인베스트먼트 심사역", expertise: ["VC투자", "밸류에이션", "초기투자", "딜소싱"], availableTime: "화/목 오전 10-12시", mentoringCount: 22, rating: 4.6, status: "APPROVED", rejectReason: "", adminMemo: "", appliedAt: "2026-01-18T09:00:00Z", approvedAt: "2026-01-19T14:00:00Z", createdAt: "2026-01-18T09:00:00Z", updatedAt: "2026-03-05T09:00:00Z" },
  { id: "mentor_003", userId: "usr_002", name: "이지은", nickname: "이지은AI", email: "jieun.lee@aicore.io", phone: "010-8765-0002", profileImageUrl: "", companyName: "에이아이코어", companyType: "스타트업", position: "CTO", category: "기술/개발", introduction: "AI/ML 기반 스타트업 기술 리딩 경험을 바탕으로 기술 전략과 팀빌딩을 멘토링합니다.", career: "에이아이코어 CTO 2년, 전 네이버 AI Lab 선임연구원", expertise: ["AI/ML", "기술전략", "CTO역할", "팀빌딩"], availableTime: "수/금 오후 3-6시", mentoringCount: 8, rating: 4.9, status: "APPROVED", rejectReason: "", adminMemo: "", appliedAt: "2026-02-01T09:00:00Z", approvedAt: "2026-02-03T11:00:00Z", createdAt: "2026-02-01T09:00:00Z", updatedAt: "2026-03-02T09:00:00Z" },
  { id: "mentor_004", userId: "usr_017", name: "문재현", nickname: "문변호사", email: "jaehyun.moon@lawfirm.kr", phone: "010-5555-0017", profileImageUrl: "", companyName: "법무법인 정의", companyType: "전문직", position: "변호사", category: "법률/세무", introduction: "스타트업 법률 자문 전문 변호사입니다. 주주간계약, 투자계약, 지적재산권 등을 다룹니다.", career: "법무법인 정의 파트너 7년, 스타트업 법률자문 200건+", expertise: ["투자계약", "주주간계약", "지적재산권", "스톡옵션"], availableTime: "월/수 오전 9-11시", mentoringCount: 12, rating: 4.7, status: "APPROVED", rejectReason: "", adminMemo: "", appliedAt: "2026-01-25T09:00:00Z", approvedAt: "2026-01-27T10:00:00Z", createdAt: "2026-01-25T09:00:00Z", updatedAt: "2026-02-28T09:00:00Z" },
  // PENDING (3)
  { id: "mentor_005", userId: "usr_003", name: "박현우", nickname: "박그린", email: "hyunwoo.park@greenlab.kr", phone: "", profileImageUrl: "", companyName: "그린랩", companyType: "스타트업", position: "CMO", category: "마케팅/그로스", introduction: "그로스해킹과 디지털 마케팅 전문가입니다. B2C 스타트업 마케팅 전략을 조언합니다.", career: "그린랩 CMO, 전 쿠팡 마케팅팀", expertise: ["그로스해킹", "퍼포먼스마케팅", "B2C"], availableTime: "평일 오후", mentoringCount: 0, rating: 0, status: "PENDING", rejectReason: "", adminMemo: "마케팅 경력 확인 필요", appliedAt: "2026-03-05T09:00:00Z", approvedAt: "", createdAt: "2026-03-05T09:00:00Z", updatedAt: "2026-03-05T09:00:00Z" },
  { id: "mentor_006", userId: "usr_011", name: "신준혁", nickname: "신넥스트", email: "joonhyuk.shin@nextcap.kr", phone: "010-3333-0011", profileImageUrl: "", companyName: "넥스트캐피탈", companyType: "투자사", position: "대표", category: "경영/전략", introduction: "스타트업 경영 전략과 조직 관리에 대해 멘토링합니다.", career: "넥스트캐피탈 대표 3년, 전 맥킨지 컨설턴트", expertise: ["경영전략", "조직관리", "스케일업"], availableTime: "월/금 오후 2-4시", mentoringCount: 0, rating: 0, status: "PENDING", rejectReason: "", adminMemo: "", appliedAt: "2026-03-08T09:00:00Z", approvedAt: "", createdAt: "2026-03-08T09:00:00Z", updatedAt: "2026-03-08T09:00:00Z" },
  { id: "mentor_007", userId: "usr_015", name: "고하나", nickname: "고코트라", email: "hana.go@kotra.or.kr", phone: "010-7777-0015", profileImageUrl: "", companyName: "KOTRA", companyType: "공공기관", position: "과장", category: "해외진출", introduction: "해외 시장 진출 전략과 수출 지원 제도에 대해 안내합니다.", career: "KOTRA 10년, 해외진출 지원 담당", expertise: ["해외진출", "수출지원", "글로벌전략"], availableTime: "평일 오전", mentoringCount: 0, rating: 0, status: "PENDING", rejectReason: "", adminMemo: "공공기관 소속 확인 필요", appliedAt: "2026-03-10T09:00:00Z", approvedAt: "", createdAt: "2026-03-10T09:00:00Z", updatedAt: "2026-03-10T09:00:00Z" },
  // REJECTED (1)
  { id: "mentor_008", userId: "usr_009", name: "권태훈", nickname: "권시드", email: "taehoon.kwon@seedfund.kr", phone: "", profileImageUrl: "", companyName: "시드펀드", companyType: "투자사", position: "심사역", category: "투자/IR", introduction: "초기 투자 심사에 대해 멘토링하고 싶습니다.", career: "시드펀드 심사역 1년", expertise: ["초기투자"], availableTime: "주말", mentoringCount: 0, rating: 0, status: "REJECTED", rejectReason: "탈퇴한 회원으로 멘토 등록이 불가합니다.", adminMemo: "usr_009 탈퇴 회원", appliedAt: "2026-02-15T09:00:00Z", approvedAt: "", createdAt: "2026-02-15T09:00:00Z", updatedAt: "2026-02-17T09:00:00Z" },
];
...
export type StudyStatus = "RECRUITING" | "IN_PROGRESS" | "COMPLETED" | "CANCELLED" | "HIDDEN";
